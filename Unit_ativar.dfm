object Form_ativar: TForm_ativar
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    Caption.Font.Style = []
    Caption.BackgroundColor = clTeal
    Caption.BackgroundColorTo = clTeal
    Caption.Line = False
    Fill.Color = clTeal
    Fill.ColorTo = clTeal
    Fill.ColorMirror = clTeal
    Fill.ColorMirrorTo = clTeal
    ...
    object Label53: TLabel
      ...
      Width = 365
      Height = 23
      Caption = 'Ativa'#231#227'o do Sistema SQL Gerencial 2.0.5 - PDV'
