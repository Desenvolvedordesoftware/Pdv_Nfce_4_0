object frmSuprimento: TfrmSuprimento
  ...
  object fxSangria1: TfrxReport
    ...
    ReportOptions.LastChange = 44611.645344270830000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
      'end.')
    OnBeforePrint = fxSangria1BeforePrint
    Left = 160
    Top = 48
    Datasets = <
      item
  ...
  object qrsuplimento_servidor: TUniQuery
  ...
  object fxSangria: TfrxReport
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 42970.860474629600000000
    ReportOptions.LastChange = 43798.887044340300000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    Datasets = <
      ...
      item
        DataSet = frxobs_sangria
        DataSetName = 'frxobs_sangria'
      end>
    Variables = <>
    Style = <>
    object Data: TfrxDataPage
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object mCaixa: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Caixa..: [frxobs_sangria."CODVENDEDOR"]')
          ParentFont = False
          WordWrap = False
        end
        object mOperador: TfrxMemoView
          Left = 4.259895000000000000
        ...
        object Memo7: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'OBS....: [frxobs_sangria."PEGO_PORQUEM"]')
          ParentFont = False
        end
  ...
  object frxobs_sangria: TfrxDBDataset
    UserName = 'frxobs_sangria'
    CloseDataSource = False
    DataSet = qrsangria
    BCDToCurrency = False
    Left = 324
