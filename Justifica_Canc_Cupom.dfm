object frmJustifica_Canc_cupom: TfrmJustifica_Canc_cupom
  Left = 0
  Top = 0
  BorderIcons = []
  BorderStyle = bsNone
  Caption = 'frmJustifica_canc_cp'
  ClientHeight = 232
  ClientWidth = 473
  Color = clHotLight
  ...
  object AdvSmoothExpanderPanel1: TAdvSmoothExpanderPanel
    ...
    object Label53: TLabel
      ...
      Width = 441
      Height = 23
      Caption = 'Justificativa para o Cancelamento da "venda".'
  ...
  object AdvSmoothExpanderPanel2: TAdvSmoothExpanderPanel
    ...
    ExplicitWidth = 478
    TMSStyle = 0
    OldHeight = 83.000000000000000000
    object bt_confirmar_fechamento: TAdvGlowButton
      Left = 0
      Top = 9
      Width = 473
      Height = 74
      ...
      Transparent = True
      TabOrder = 0
      OnClick = bt_confirmar_fechamentoClick
