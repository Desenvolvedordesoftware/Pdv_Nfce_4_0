object frmmodulo: Tfrmmodulo
  ...
  object conn: TSQLConnection
    ...
    Params.Strings = (
      ...
      'Database=C:\SQL_Gerencial\Server\BD\BASE.FDB'
      'User_Name=sysdba'
      'Password=masterkey'
      'Role=RoleName'
      'MaxBlobSize=-1'
  ...
  object boleto: TACBrBoleto
    ...
    DirArqRemessa = 'C:\SQL_Gerencial\SERVER\cob\Remessa'
    DirArqRetorno = 'C:\SQL_Gerencial\SERVER\cob\Retorno'
    NumeroArquivo = 0
  ...
  object BoletoFR: TACBrBoletoFCFR
    ACBrBoleto = boleto
    DirLogo = 'C:\SQL_Gerencial\SERVER\img\Logos\Colorido'
    SoftwareHouse = 'SQL Gerencial 2.0.5'
    FastReportFile = 'C:\SQL_Gerencial\SERVER\rel\Boleto.fr3'
    ModoThread = False
  ...
  object Conexao_pdv: TZConnection
    ControlsCodePage = cCP_UTF16
    Catalog = ''
    Properties.Strings = (
      'controls_cp=CP_UTF16')
