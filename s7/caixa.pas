...
uses
  ...
  JvToolEdit, JvBaseEdits, frxClass;
...
uses modulo1, caixa_abertura, principal1,
// caixa_abertura_individual,
  caixa_fechamento, caixa_ficha;
  // lista_caixa2;
...
begin
if application.MessageBox('Confirma cancelamento deste venda?', 'AVISO',
      mb_yesno + mb_iconquestion) = idyes then
  begin
  ...
  application.MessageBox('Venda Cancelada com sucesso', 'Aviso',
      mb_ok + MB_ICONWARNING);
  end;
end;
