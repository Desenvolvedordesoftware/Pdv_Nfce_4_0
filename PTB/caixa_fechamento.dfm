object frmCaixa_Fechamento: TfrmCaixa_Fechamento
  ...
  object Panel4: TPanel
    ...
    object bt_fechamento02: TAdvGlowButton
      Left = 98
      Top = 6
      Width = 100
      Height = 33
    ...
    object bt_fechamento03: TAdvGlowButton
      Left = 200
      Top = 6
      Width = 64
      Height = 33
    ...
    object bt_fechamento04: TAdvGlowButton
      Left = 266
      Top = 6
      Width = 85
      Height = 33
    ...
    object bt_fechamento05: TAdvGlowButton
      Left = 353
      Top = 6
      Width = 65
      Height = 33
    ...
    object bt_fechamento06: TAdvGlowButton
      Left = 420
      Top = 6
      Width = 76
      Height = 33
    ...
    object bt_fechamento07: TAdvGlowButton
      Left = 498
      Top = 6
      Width = 106
      Height = 33
      Caption = 'F. Pagamentos'
      Font.Charset = ANSI_CHARSET
      Font.Color = clWhite
      Font.Height = -11
      Font.Name = 'Tahoma'
    ...
    object bt_fechamento08: TAdvGlowButton
      Left = 606
      Top = 6
      Width = 69
      Height = 33
  ...
  object fxFechamento: TfrxReport
    ...
    ReportOptions.LastChange = 43626.273487407400000000
    ...
    Datasets = <
      ...
      item
        DataSet = frxDBDaprazo
        DataSetName = 'frxDBDaprazo'
      end
      item
        DataSet = frxdbdtst1
      ...
      item
        DataSet = frxDBDcartaoc
        DataSetName = 'frxDBDcartaoc'
      end
      item
        DataSet = frxDBDcartaod
        DataSetName = 'frxDBDcartaod'
      end
      item
        DataSet = frxDBDdinheiro
        DataSetName = 'frxDBDdinheiro'
      end
      item
        DataSet = frxDBDFechamento
        DataSetName = 'frxDBDFechamento'
      end
      item
        DataSet = frxDBDsangria
        DataSetName = 'frxDBDsangria'
      end
      item
        DataSet = frxDBDsuprimento
        DataSetName = 'frxDBDsuprimento'
      end>
    Variables = <>
    Style = <>
    ...
    object Page1: TfrxReportPage
      ...
      object PageHeader1: TfrxPageHeader
        ...
        object mOperador: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            'Operador: [frxDBDataset1."CODFUNCIONARIO"]')
          ParentFont = False
          WordWrap = False
        end
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo7: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[frxDBDdinheiro.."FORMA_PAGAMENTO"]')
          ParentFont = False
        end
  ...
  object cdsDados: TClientDataSet
    ...
    object cdsDadosnegrito: TStringField
      FieldName = 'negrito'
      Size = 1
    end
    object cdsDadoslinha: TIntegerField
      FieldName = 'linha'
    end
  end
  ...
  object frxDBDFechamento: TfrxDBDataset
    UserName = 'frxDBDFechamento'
    CloseDataSource = False
  ...
  object frxDBDsuprimento: TfrxDBDataset
    UserName = 'frxDBDsuprimento'
    CloseDataSource = False
    DataSet = qrsuprimento
    BCDToCurrency = False
    Left = 32
    Top = 200
  end
  object qrsuprimento: TUniQuery
    Connection = frmModulo.conexao
    Left = 29
    Top = 246
  end
  object qrsangria: TUniQuery
    Connection = frmModulo.conexao
    Left = 109
    Top = 254
  end
  object frxDBDsangria: TfrxDBDataset
    UserName = 'frxDBDsangria'
    CloseDataSource = False
    DataSet = qrsangria
    BCDToCurrency = False
    Left = 112
  ...
  object frxDBDdinheiro: TfrxDBDataset
    UserName = 'frxDBDdinheiro'
    CloseDataSource = False
    DataSet = qrdinheiro
    BCDToCurrency = False
    Left = 176
  ...
  object frxDBDaprazo: TfrxDBDataset
    UserName = 'frxDBDaprazo'
    CloseDataSource = False
    DataSet = qraprazo
    BCDToCurrency = False
    Left = 256
  ...
  object qrdinheiro: TUniQuery
    Connection = frmModulo.conexao
    Left = 173
    Top = 254
  end
  object qraprazo: TUniQuery
    Connection = frmModulo.conexao
    Left = 253
    Top = 262
  end
  object frxDBDcartaoc: TfrxDBDataset
    UserName = 'frxDBDcartaoc'
    CloseDataSource = False
    DataSet = qrcartaoc
    BCDToCurrency = False
    Left = 344
  ...
  object frxDBDcartaod: TfrxDBDataset
    UserName = 'frxDBDcartaod'
    CloseDataSource = False
    DataSet = qrcartaod
    BCDToCurrency = False
    Left = 424
  ...
  object qrcartaoc: TUniQuery
    Connection = frmModulo.conexao
    Left = 341
    Top = 262
  end
  object qrcartaod: TUniQuery
    Connection = frmModulo.conexao
    Left = 421
    Top = 270
  end
  object frxrelatorio: TfrxReport
    ...
    PrintOptions.PrintOnSheet = 0
    ReportOptions.CreateDate = 43652.587404467600000000
    ReportOptions.LastChange = 43652.587404467600000000
    ScriptLanguage = 'PascalScript'
    ScriptText.Strings = (
      'begin'
      ''
    ...
    object Page1: TfrxReportPage
      ...
      object ReportTitle1: TfrxReportTitle
        ...
        object mCaixa: TfrxMemoView
          Left = 2.031540000000000000
          Top = 108.063080000000000000
          Width = 75.590600000000000000
          Height = 15.118120000000000000
          AutoWidth = True
          Font.Charset = DEFAULT_CHARSET
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo7: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '(Saida)[frxDBDsangria."FORMA_PAGAMENTOS"].-.:')
          ParentFont = False
        end
        object Memo8: TfrxMemoView
      ...
      object MasterData2: TfrxMasterData
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '(Entrada)[frxDBDsuprimento."FORMA_PAGAMENTOSP"].+.:')
          ParentFont = False
        end
        object Memo2: TfrxMemoView
      ...
      object MasterData3: TfrxMasterData
        ...
        object Memo4: TfrxMemoView
          ...
          Font.Style = []
          Memo.UTF8W = (
            '[(<frxDBDdinheiro."TOTAL">-<frxDBDdinheiro."TROCO">)]')
          ParentFont = False
        end
      end
      object MasterData4: TfrxMasterData
        ...
        object Memo5: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDcartaod."FORMA_PAGAMENTOD"].+.:')
          ParentFont = False
        end
        object Memo6: TfrxMemoView
          Left = 101.370130000000000000
      ...
      object MasterData5: TfrxMasterData
        ...
        object Memo9: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDcartaoc."FORMA_PAGAMENTOC"].+.:')
          ParentFont = False
        end
        object Memo10: TfrxMemoView
          Left = 101.370130000000000000
      ...
      object MasterData6: TfrxMasterData
        ...
        object Memo11: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDaprazo."FORMA_PAGAMENTOAP"].+.:')
          ParentFont = False
        end
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo13: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(<frxDBDaprazo."TOTALAP">+<frxDBDcartaoc."TOTALC">+<frxDBDcarta' +
              'od."TOTALD">+<frxDBDdinheiro."TOTAL">+<frxDBDsuprimento."VALORSP' +
              '">-<frxDBDdinheiro."TROCO">)]')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          ...
          Font.Style = [fsBold]
          Memo.UTF8W = (
            'Movimento Geral_Entrada..: +')
          ParentFont = False
        end
        object Memo15: TfrxMemoView
          Left = 31.440940000000000000
          ...
          Memo.UTF8W = (
              ...
              '+ [(<frxDBDdinheiro."TOTAL">+<frxDBDsuprimento."VALORSP">-<frxDB' +
              'Ddinheiro."TROCO">)]')
          ParentFont = False
        end
        ...
        object Memo21: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[(<frxDBDdinheiro."TOTAL">+<frxDBDsuprimento."VALORSP">-<frxDBDs' +
              'angria."VALORS">-<frxDBDdinheiro."TROCO">)]')
          ParentFont = False
        end
        object Memo22: TfrxMemoView
          Left = 0.779530000000000000
          Top = 78.826840000000000000
          Width = 151.181200000000000000
          Height = 15.118120000000000000
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWindowText
  ...
  object frxRelatorioDetalhado: TfrxReport
    Version = '5.4.6'
    DotMatrixReport = False
    IniFile = '\Software\Fast Reports'
    PreviewOptions.Buttons = [pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick]
    ...
    object Page1: TfrxReportPage
      ...
      object MasterData1: TfrxMasterData
        ...
        object Memo7: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDsangria."FORMA_PAGAMENTOS"].-.:')
          ParentFont = False
        end
        object Memo8: TfrxMemoView
          Left = 101.370130000000000000
      ...
      object MasterData2: TfrxMasterData
        ...
        object Memo1: TfrxMemoView
          ...
          HAlign = haRight
          Memo.UTF8W = (
            '[frxDBDsuprimento."FORMA_PAGAMENTOSP"].+.:')
          ParentFont = False
        end
        object Memo2: TfrxMemoView
          Left = 101.370130000000000000
      ...
      object ReportSummary1: TfrxReportSummary
        ...
        object Memo13: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<frxDBDaprazo."TOTALAP">+<frxDBDcartaoc."TOTALC">+<frxDBDca' +
              'rtaod."TOTALD">+<frxDBDdinheiro."TOTAL">+<frxDBDsuprimento."VALO' +
              'RSP">+<frxDBDsangria."VALORS">-<frxDBDdinheiro."TROCO">)]')
          ParentFont = False
        end
        object Memo14: TfrxMemoView
          Width = 185.196970000000000000
        ...
        object Memo15: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '+ [SUM(<frxDBDdinheiro."TOTAL">+<frxDBDsuprimento."VALORSP">-<fr' +
              'xDBDdinheiro."TROCO">)]')
          ParentFont = False
        end
        object Memo16: TfrxMemoView
        ...
        object Memo21: TfrxMemoView
          ...
          Memo.UTF8W = (
              ...
              '[SUM(<frxDBDdinheiro."TOTAL">+<frxDBDsuprimento."VALORSP">-<frxD' +
              'BDsangria."VALORS">-<frxDBDdinheiro."TROCO">)]')
          ParentFont = False
        end
        object Memo22: TfrxMemoView
          Left = 0.779530000000000000
