object frmnotafiscal: Tfrmnotafiscal
  ...
  object qrnotafiscal_item: TUniQuery
    ...
    object qrnotafiscal_itemCOMPLEMENTO: TStringField
  ...
  object qrapoio: TUniQuery
    ...
    object qrapoioCLASSIFICACAO_FISCAL: TStringField
      FieldName = 'CLASSIFICACAO_FISCAL'
    end
  end
  object qrnf: TUniQuery
    Connection = frmModulo.Conexao_Servidor
    SQL.Strings = (
      'select * from c000031')
    Left = 487
    ...
    object qrnfMODELO_NF: TStringField
      FieldName = 'MODELO_NF'
      Size = 2
    end
    object qrnfSERIE_NF: TStringField
      FieldName = 'SERIE_NF'
      Size = 3
    end
    ...
    object qrnfSITUACAO_A: TStringField
      FieldName = 'SITUACAO_A'
      Size = 1
    end
  end
  object qrmodelo: TUniQuery
    Connection = frmModulo.Conexao_Servidor
    SQL.Strings = (
      'select * from c000082')
    Left = 32
  ...
  object qrsoma: TUniQuery
    ...
    Left = 112
    Top = 279
    object qrsomaTOTAL: TFloatField
      FieldName = 'TOTAL'
      ReadOnly = True
    end
  end
  object qrgrade_entrada: TUniQuery
    SQL.Strings = (
      'select * from c000033')
    Left = 184
    Top = 287
  ...
  object qrnotafiscal: TUniQuery
    ...
    object qrnotafiscalNOME: TStringField
      FieldName = 'NOME'
      Size = 80
    end
    object qrnotafiscalAPELIDO: TStringField
      FieldName = 'APELIDO'
      Size = 50
    end
    ...
    object qrnotafiscalBAIRRO: TStringField
      FieldName = 'BAIRRO'
      Size = 30
    end
    object qrnotafiscalCIDADE: TStringField
      FieldName = 'CIDADE'
      Size = 40
    end
    object qrnotafiscalUF: TStringField
      FieldName = 'UF'
      Size = 2
    end
    object qrnotafiscalCEP: TStringField
      FieldName = 'CEP'
      Size = 10
    end
    object qrnotafiscalCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 80
    end
    object qrnotafiscalMORADIA: TIntegerField
      FieldName = 'MORADIA'
    end
    object qrnotafiscalTIPO: TIntegerField
      FieldName = 'TIPO'
    end
    object qrnotafiscalSITUACAO: TIntegerField
      FieldName = 'SITUACAO'
    end
    object qrnotafiscalTELEFONE1: TStringField
      FieldName = 'TELEFONE1'
    end
    object qrnotafiscalTELEFONE2: TStringField
      FieldName = 'TELEFONE2'
    end
    object qrnotafiscalTELEFONE3: TStringField
      FieldName = 'TELEFONE3'
    end
    object qrnotafiscalCELULAR: TStringField
      FieldName = 'CELULAR'
    end
    object qrnotafiscalEMAIL: TStringField
      FieldName = 'EMAIL'
      Size = 50
    end
    ...
    object qrnotafiscalFILIACAO: TStringField
      FieldName = 'FILIACAO'
      Size = 80
    end
    object qrnotafiscalESTADOCIVIL: TStringField
      FieldName = 'ESTADOCIVIL'
      Size = 15
    end
    object qrnotafiscalCONJUGE: TStringField
      FieldName = 'CONJUGE'
      Size = 60
    end
    object qrnotafiscalPROFISSAO: TStringField
      FieldName = 'PROFISSAO'
      Size = 30
    end
    object qrnotafiscalEMPRESA: TStringField
      FieldName = 'EMPRESA'
      Size = 40
    end
    object qrnotafiscalRENDA: TFloatField
      FieldName = 'RENDA'
    end
    object qrnotafiscalLIMITE: TFloatField
      FieldName = 'LIMITE'
    end
    object qrnotafiscalREF1: TStringField
      FieldName = 'REF1'
      Size = 50
    end
    object qrnotafiscalREF2: TStringField
      FieldName = 'REF2'
      Size = 50
    end
    object qrnotafiscalCODVENDEDOR: TStringField
      FieldName = 'CODVENDEDOR'
      Size = 6
    end
    object qrnotafiscalDATA_CADASTRO: TDateTimeField
      FieldName = 'DATA_CADASTRO'
    end
    object qrnotafiscalDATA_ULTIMACOMPRA: TDateTimeField
      FieldName = 'DATA_ULTIMACOMPRA'
    end
    ...
    object qrnotafiscalOBS4: TStringField
      FieldName = 'OBS4'
      Size = 80
    end
    object qrnotafiscalOBS5: TStringField
      FieldName = 'OBS5'
      Size = 80
    end
    object qrnotafiscalOBS6: TStringField
      FieldName = 'OBS6'
      Size = 80
    end
    object qrnotafiscalNASCIMENTO: TStringField
      FieldName = 'NASCIMENTO'
      Size = 10
    end
    object qrnotafiscalCODREGIAO: TStringField
      FieldName = 'CODREGIAO'
      Size = 6
    end
    object qrnotafiscalCODCONVENIO: TStringField
      FieldName = 'CODCONVENIO'
      Size = 6
    end
    object qrnotafiscalCODUSUARIO: TStringField
      FieldName = 'CODUSUARIO'
      Size = 6
    end
    ...
    object qrnotafiscalRG_ORGAO: TStringField
      FieldName = 'RG_ORGAO'
      Size = 5
    end
    object qrnotafiscalRG_ESTADO: TStringField
      FieldName = 'RG_ESTADO'
      Size = 2
    end
    object qrnotafiscalRG_EMISSAO: TDateTimeField
      FieldName = 'RG_EMISSAO'
    end
    object qrnotafiscalSEXO: TStringField
      FieldName = 'SEXO'
      Size = 1
    end
    object qrnotafiscalHISTORICO: TBlobField
      FieldName = 'HISTORICO'
    end
    object qrnotafiscalPREVISAO: TDateTimeField
      FieldName = 'PREVISAO'
    end
    object qrnotafiscalCNAE: TStringField
      FieldName = 'CNAE'
      Size = 10
    end
    object qrnotafiscalCOD_MUNICIPIO_IBGE: TStringField
      FieldName = 'COD_MUNICIPIO_IBGE'
      Size = 10
    end
    object qrnotafiscalIBGE: TStringField
      FieldName = 'IBGE'
      Size = 5
    end
    object qrnotafiscalTAMANHO_CALCA: TStringField
      FieldName = 'TAMANHO_CALCA'
      Size = 5
    end
    object qrnotafiscalTAMANHO_BLUSA: TStringField
      FieldName = 'TAMANHO_BLUSA'
      Size = 5
    end
    object qrnotafiscalTAMANHO_SAPATO: TStringField
      FieldName = 'TAMANHO_SAPATO'
      Size = 5
    end
    object qrnotafiscalCORRESP_ENDERECO: TStringField
      FieldName = 'CORRESP_ENDERECO'
      Size = 80
    end
    object qrnotafiscalCORRESP_BAIRRO: TStringField
      FieldName = 'CORRESP_BAIRRO'
      Size = 30
    end
    object qrnotafiscalCORRESP_CIDADE: TStringField
      FieldName = 'CORRESP_CIDADE'
      Size = 40
    end
    object qrnotafiscalCORRESP_UF: TStringField
      FieldName = 'CORRESP_UF'
      Size = 2
    end
    object qrnotafiscalCORRESP_CEP: TStringField
      FieldName = 'CORRESP_CEP'
      Size = 10
    end
    object qrnotafiscalCORRESP_COMPLEMENTO: TStringField
      FieldName = 'CORRESP_COMPLEMENTO'
      Size = 40
    end
    object qrnotafiscalRG_PRODUTOR: TStringField
      FieldName = 'RG_PRODUTOR'
      Size = 30
    end
    object qrnotafiscalRESP1_NOME: TStringField
      FieldName = 'RESP1_NOME'
      Size = 80
    end
    object qrnotafiscalRESP1_CPF: TStringField
      FieldName = 'RESP1_CPF'
      Size = 25
    end
    object qrnotafiscalRESP1_RG: TStringField
      FieldName = 'RESP1_RG'
      Size = 25
    end
    object qrnotafiscalRESP1_PROFISSAO: TStringField
      FieldName = 'RESP1_PROFISSAO'
      Size = 50
    end
    object qrnotafiscalRESP1_ESTADO_CIVIL: TStringField
      FieldName = 'RESP1_ESTADO_CIVIL'
      Size = 30
    end
    object qrnotafiscalRESP1_ENDERECO: TStringField
      FieldName = 'RESP1_ENDERECO'
      Size = 80
    end
    object qrnotafiscalRESP1_BAIRRO: TStringField
      FieldName = 'RESP1_BAIRRO'
      Size = 40
    end
    object qrnotafiscalRESP1_CIDADE: TStringField
      FieldName = 'RESP1_CIDADE'
      Size = 40
    end
    object qrnotafiscalRESP1_UF: TStringField
      FieldName = 'RESP1_UF'
      Size = 2
    end
    object qrnotafiscalRESP1_CEP: TStringField
      FieldName = 'RESP1_CEP'
      Size = 15
    end
    object qrnotafiscalRESP2_NOME: TStringField
      FieldName = 'RESP2_NOME'
      Size = 80
    end
    object qrnotafiscalRESP2_CPF: TStringField
      FieldName = 'RESP2_CPF'
      Size = 25
    end
    object qrnotafiscalRESP2_RG: TStringField
      FieldName = 'RESP2_RG'
      Size = 25
    end
    object qrnotafiscalRESP2_PROFISSAO: TStringField
      FieldName = 'RESP2_PROFISSAO'
      Size = 50
    end
    object qrnotafiscalRESP2_ESTADO_CIVIL: TStringField
      FieldName = 'RESP2_ESTADO_CIVIL'
      Size = 30
    end
    object qrnotafiscalRESP2_ENDERECO: TStringField
      FieldName = 'RESP2_ENDERECO'
      Size = 80
    end
    object qrnotafiscalRESP2_BAIRRO: TStringField
      FieldName = 'RESP2_BAIRRO'
      Size = 40
    end
    object qrnotafiscalRESP2_CIDADE: TStringField
      FieldName = 'RESP2_CIDADE'
      Size = 40
    end
    object qrnotafiscalRESP2_UF: TStringField
      FieldName = 'RESP2_UF'
      Size = 2
    end
    object qrnotafiscalRESP2_CEP: TStringField
      FieldName = 'RESP2_CEP'
      Size = 15
    end
    object qrnotafiscalFOTO: TStringField
      FieldName = 'FOTO'
      Size = 80
    end
    object qrnotafiscalCONDPGTO: TStringField
      FieldName = 'CONDPGTO'
      Size = 100
    end
  end
