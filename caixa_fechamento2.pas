...
procedure TfrmCaixa_Fechamento.frxPDFExport1BeforeExport(Sender: TObject);
begin
...
var
  codOperador:string;
  dValor, dSangria, dSuprimento, dTotal, dDinheiro:double;
begin
  dValor := 0;  dSangria := 0;  dSuprimento := 0;  dTotal := 0; dDinheiro:=0;
...
//  GridFechamento.Cell[3,GridFechamento.LastAddedRow].AsString := FormatarValor(-dTroco,2,false);
   ...
   GridFechamento.Cell[3,GridFechamento.LastAddedRow].AsString := FormatarValor(dDinheiro,2,false);
   GridFechamento.Cell[2,GridFechamento.LastAddedRow].FontStyle := [fsBold];
   GridFechamento.Cell[3,GridFechamento.LastAddedRow].FontStyle := [fsBold];
...
{   GridFechamento.AddRow(1);
   ...
   GridFechamento.Cell[3,GridFechamento.LastAddedRow].AsString := FormatarValor(dTotal - dSangria - dSangria,2,false);
   GridFechamento.Cell[2,GridFechamento.LastAddedRow].FontStyle := [fsBold];
   GridFechamento.Cell[3,GridFechamento.LastAddedRow].FontStyle := [fsBold];
