...
uses
  ...
  ExtCtrls, RzLabel, TFlatPanelUnit, TypInfo, consumidor;

type
  TfrmConsumidor1 = class(TForm)
    ...
    procedure pn_consumidorClick(Sender: TObject);
  private
...
uses modulo, funcoes, principal, venda, cliente_consulta, Types;

{$R *.dfm}

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.FormClose(Sender: TObject;
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.FormCreate(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.FormShow(Sender: TObject);
begin
  //ed_consumid_nome.SetFocus;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cpfKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_vendedorKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
   // bt_gravar_consumid.setfocus
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.MenuItem2Click(Sender: TObject);
begin
  close;
end;

procedure TfrmConsumidor1.pn_consumidorClick(Sender: TObject);
begin

end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.bt_gravar_consumidClick(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.bt_cancelar_consumidClick(Sender: TObject);
begin
  sCli_codigo   := '';
  bContinua     := false;
  close;
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_nomeEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_nomeExit(Sender: TObject);
begin
//  sh_cosumid_nome.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_enderecoEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_enderecoExit(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cidadeEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cidadeExit(Sender: TObject);
begin
//  sh_consumid_cidade.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_ufEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_ufExit(Sender: TObject);
begin
//  sh_consumid_uf.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cepEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cpfEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cpfExit(Sender: TObject);
begin
//  sh_consumid_cpf.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_kmEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_kmExit(Sender: TObject);
begin
//  sh_consumid_km.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_placaExit(Sender: TObject);
begin
//  sh_consumid_placa.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_placaEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_vendedorEnter(Sender: TObject);
begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_vendedorExit(Sender: TObject);
begin
//  sh_consumid_vendedor.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_cepExit(Sender: TObject);
begin
//    sh_consumid_cep.Brush.Color := clblack;
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_nomeKeyPress(Sender: TObject;
  var Key: Char);
var
  iRet: Integer;
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.ed_consumid_enderecoKeyPress(Sender: TObject;
  var Key: Char);
begin
  if iTeclado_Modelo = 1 then
  begin
...
// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.bt_gravar_consumidEnter(Sender: TObject);
begin
  frmvenda.Imprime_display('ENTER para confirmar o consumidor',clwhite,tiCliente);
end;

// -------------------------------------------------------------------------- //
procedure TfrmConsumidor1.bt_cancelar_consumidEnter(Sender: TObject);
begin
  frmvenda.Imprime_display('ENTER para cancelar o consumidor',clwhite,tiCliente);
end;

// -------------------------------------------------------------------------- //
function TfrmConsumidor1.LocalizarCliente: Integer;
begin
...
procedure TfrmConsumidor1.LimpaCampos;
var
  I: Integer;
