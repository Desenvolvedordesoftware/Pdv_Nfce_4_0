...
uses
  ...
  Dialogs, StdCtrls, Mask, ExtCtrls, DB, MemDS, DBAccess, RzPrgres, ComCtrls, Menus, Uni,
  JvExMask, JvToolEdit;
...
var
  ...
  // variaveis do sintegra - store_protheus
...
begin
 if retorno = -1 then
 // showmessage('Erro na chamada da função! Verifique o erro em C:\ACTHAUROS\paf\Log_Erro.txt')
 else
 if retorno = 0 then
