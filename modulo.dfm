object frmModulo: TfrmModulo
  ...
  object conexao: TUniConnection
    ...
    Port = 3050
    Database = 'C:\ACTHAUROS\PDV\BD\NFCE_DATPDV.FDB'
    Username = 'sysdba'
    Server = 'LOCALHOST'
    LoginPrompt = False
    Left = 48
    Top = 24
    EncryptedPassword = '98FF9CFF8CFFBFFFCEFFC6FFCBFFC9FF'
  end
  object Conexao_Servidor: TUniConnection
    ProviderName = 'InterBase'
    Port = 3050
    Database = 'C:\ACTHAUROS\Server\BD\BASE.FDB'
    Username = 'sysdba'
    Server = 'LOCALHOST'
    LoginPrompt = False
    Left = 144
  ...
  object spCupom_Crediario: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        ' :DATA, :HORA, :COD_CLIENTE, :VENCIMENTO, :VALOR, :DESCRICAO, :C' +
        'ANCELADO)')
    Connection = conexao
    Left = 48
    Top = 192
  ...
  object spCupom: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        ', :COD_CAIXA, :ECF_CAIXA, :CONTINGENCIA, :GERADO_NFCE)')
    Connection = conexao
    Left = 136
    Top = 192
    ParamData = <
  ...
  object spCupom_Forma: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        'RMA, :VALOR, :PRESTACAO, :TIPO, :BANCO, :TIPOCARTAO, :CANCELADO)')
    Connection = conexao
    Left = 440
    Top = 184
    ParamData = <
  ...
  object spCupom_Item_Temp: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        ':ALIQUOTA, :CANCELADO, :COD_TOTALIZADOR, :TAMANHO, :COR, :CAIXA,' +
        ' :COD_BARRA, :PRODUTO)')
    Connection = conexao
  ...
  object spCupom_Item: TUniStoredProc
    ...
    SQL.Strings = (
        ...
        'UOTA, :CANCELADO, :COD_TOTALIZADOR, :TAMANHO, :COR, :PRODUTO, :C' +
        'OD_BARRA)')
    Connection = conexao
    Left = 512
    Top = 328
  ...
  object ACBRDANFENFCe: TACBrNFeDANFEFR
    Impressora = 'PADRAO'
    PathPDF = 'C:\GCSISTEM\PDV\xml\'
    Logo = 'C:\GCSISTEM\PDV\Img\logo-nfce.jpg'
    Sistema = 'GCSISTEMAS - V2021'
  ...
  object spNFCE_Insert: TUniStoredProc
    StoredProcName = 'NFCE_INSERT'
    SQL.Strings = (
      
        'EXECUTE PROCEDURE NFCE_INSERT(:PNUMERO, :PDATA, :PHORA, :PTOTAL,' +
  ...
  object qrtipo_impressora: TUniQuery
    Connection = conexao
    SQL.Strings = (
      'select * from c000000')
    Left = 568
  ...
  object qrfatasia: TUniQuery
    Connection = Conexao_Numerador
    SQL.Strings = (
      'select * from c000004 '
      'WHERE CODIGO ='#39'000001'#39
      'order by FILIAL')
    Left = 792
    Top = 352
  end
  object spNao_FiscalSV: TUniStoredProc
  ...
  object qrvendanfce: TUniQuery
    Connection = Conexao_Servidor
    Left = 40
    Top = 480
  end
  object spCupom_FormaSV: TUniStoredProc
    StoredProcName = 'ST_CUPOM_FORMA_INSERT'
    SQL.Strings = (
