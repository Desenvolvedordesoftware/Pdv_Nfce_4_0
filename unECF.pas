...
var
  ...
  aRelatoriosGerenciais : array[1..50, 1..2] of AnsiString;

function Executa_programa(const FileName, Params: AnsiString; const WindowState: Word): boolean;
(***************************** FUNCOES ****************************************)

// Retornos
function cECF_Analisa_Retorno(COD_ECF:Integer):AnsiString;
function cECF_Retorno_Impressora(COD_ECF:Integer):AnsiString;
// Inicializacao

function cECF_Abre(COD_ECF:Integer;Porta:AnsiString):AnsiString;
function cECF_Fecha(COD_ECF:Integer):AnsiString;

// Informacoes e Status
function cECF_Ligada(COD_ECF:Integer):AnsiString;
function cECF_Numero_Serie(COD_ECF:Integer):AnsiString;
function cECF_Numero_Caixa(COD_ECF:Integer):AnsiString;
function cECF_Numero_Cupom(COD_ECF:Integer):AnsiString;
function cECF_COO_Nao_Fiscal(COD_ECF:Integer):AnsiString;
function cECF_Numero_Contador_Cupom(COD_ECF:Integer):AnsiString;
function cECF_Numero_Contador_Relatorio_Gerencial(COD_ECF:integer):AnsiString;
function cECF_Numero_Contador_Operacao_NF(COD_ECF:integer):AnsiString;
function cECF_Numero_Contador_Comprovante_CD(COD_ECF:integer):AnsiString;
function cECF_Numero_Contador_Gerencial(COD_ECF:integer):AnsiString;
function cECF_Data_Hora(COD_ECF:Integer):AnsiString;

function cECF_Download(COD_ECF:Integer;tipo:AnsiString;Inicio:AnsiString;
  Fim:AnsiString):AnsiString;

function cECF_Registro60A(COD_ECF:Integer):AnsiString;
function cECF_Registro60M(COD_ECF:Integer):AnsiString;
function cECF_Le_Formas_Pgto(COD_ECF:Integer):AnsiString;
function cECF_Arquivo_Fiscal_CAT52(COD_ECF:integer;tipo,inicio,fim:AnsiString):AnsiString;
function cECF_Marca_ECF(COD_ECF:integer):AnsiString;
function cECF_Modelo_ECF(COD_ECF:integer):AnsiString;
function cECF_Tipo_ECF(COD_ECF:integer):AnsiString;
function cECF_MF_Adicional(COD_ECF:integer):AnsiString;
function cECF_Versao_SB(COD_ECF:integer):AnsiString;
function cECF_Data_Hora_SB(COD_ECF:integer):AnsiString;
function cECF_Total_Cupom(COD_ECF:integer):real;
function cECF_Verifica_Z_automatico(COD_ECF:integer):AnsiString;
function cECF_Verifica_Horario_Verao(COD_ECF:integer):AnsiString;
function cECF_Verifica_Aliquotas(COD_ecf:integer):AnsiString;
function cECF_Verifica_Totalizadores_NF(COD_ECF:integer):AnsiString;
function cECF_Data_Movimento(cod_ECF:integer):AnsiString;
function cECF_Cupom_Fiscal_Aberto(cod_ECF:integer):AnsiString;
function cECF_Grande_Total(cod_ECF:integer):AnsiString;
function cECF_VerificarRelatoriosGerenciais(COD_ECF: Integer): AnsiString;

// Informacoes ref. reducao Z
function cECF_ReducaoZ_Contador_CRZ(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Contador_COO(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Contador_CRO(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_DataHora(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Data_Movimento(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Venda_Bruta(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Total_ISS(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Totalizador_Geral(COD_ECF:integer):AnsiString;
function cECF_ReducaoZ_Totalizador_Parcial(COD_ECF:Integer):AnsiString;
// Relatorios
function cECF_LeituraX(COD_ECF:Integer):AnsiString;
function cECF_ReducaoZ(COD_ECF:Integer):AnsiString;
function cECF_Leitura_Memoria_Fiscal(COD_ECF:INTEGER;
                                     Tipo:AnsiString; // DATA ou CRZ
                                     Analitica_ou_Sintetica : AnsiString; // A ou S
                                     Ecf_ou_Arquivo : AnsiString; // ECF ou ARQUIVO
                                     Inicio:AnsiString;Fim:AnsiString):AnsiString;
// Cupom
function cECF_Abre_Cupom(COD_ECF:Integer;CPF,Nome,Endereco:AnsiString;
  pbImprimirNoCabecalho: Boolean = False):AnsiString;
function cECF_Vende_item(COD_ECF:Integer;Codigo,produto,unidade,aliquota:AnsiString;quantidade,valor_unitario,valor_desconto:real;valor_acrescimo:real;tipo_desconto_acrescimo:AnsiString;total:real):AnsiString;
function cECF_Inicia_Fechamento(COD_ECF:Integer;Acrescimo_ou_Desconto:AnsiString;tipo:AnsiString;valor:real):AnsiString;
function cECF_Forma_Pgto(COD_ECF:Integer;forma_pgto:AnsiString;valor:real):AnsiString;
function cECF_Termina_Fechamento(COD_ECF:Integer;mensagem:AnsiString):AnsiString;
function cECF_Fecha_Cupom_Resumido(COD_ECF:Integer;forma_pgto:AnsiString;mensagem:AnsiString; Valor: Currency = 0.00):AnsiString;
function cECF_Cancela_Cupom(COD_ECF:Integer):AnsiString;
function cECF_Cancela_Item(COD_ECF:Integer;Item:AnsiString):AnsiString;
// Operações Não Fiscal
function cECF_Abre_Gerencial(COD_ECF:Integer;Texto:AnsiString):AnsiString;
function cECF_Usa_Gerencial(COD_ECF:Integer;Texto:AnsiString):AnsiString;
function cECF_Fecha_Gerencial(COD_ECF:Integer):AnsiString;
function cECF_Abre_CNFV(COD_ECF:Integer;Forma_Pgto:AnsiString;Valor:real;Numero_Cupom:AnsiString):AnsiString;
function cECF_Usa_CNFV(COD_ECF:Integer;Texto:AnsiString):AnsiString;
function cECF_Fecha_CNFV(COD_ECF:Integer):AnsiString;
function cECF_Sangria(COD_ECF:Integer;Valor:real):AnsiString;
function cECF_Suprimento(COD_ECF:Integer;Valor:real;Forma_Pgto:AnsiString):AnsiString;
function cECF_Recebimento(COD_ECF:Integer;Totalizador:AnsiString;Valor:real;Forma_Pgto:AnsiString):AnsiString;
// Programacao
function cECF_Programa_Horario_Verao(COD_ECF:integer):AnsiString;
function cECF_Programa_Aliquota(COD_ECF:integer;aliquota:real;ICMS_ou_ISS:AnsiString):AnsiString;
function cECF_Programa_Totalizador(COD_ECF:Integer;Indice:integer;descricao:AnsiString):AnsiString;
function cECF_Programa_Forma_Pgto(COD_ECF:Integer;Forma_Pgto:AnsiString;Vinculado:AnsiString):AnsiString;
function cECF_Daruma_Libera_Porta(SIM_NAO:AnsiString):AnsiString;
function cECF_Programa_Z_Automatico(COD_ECF:INTEGER;SIM_NAO:AnsiString):AnsiString;
// Outros
function cECF_Status_Gaveta(COD_ECF:integer):AnsiString;
function cECF_Abre_Gaveta(COD_ECF:integer):AnsiString;
function cECF_Desliga_Janelas(COD_ECF:integer):AnsiString;
(******************************************************************************)
...
function Bematech_FI_DataHoraGravacaoUsuarioSWBasicoMFAdicional( dataUsuario, dataSWBasico, MFAdicional:AnsiString ): Integer; StdCall; External 'BEMAFI32.DLL';
...
function Bematech_FI_VendaBruta( Valor:AnsiString ): Integer; StdCall; External 'BEMAFI32.DLL';
...
function Bematech_FI_GeraRegistrosCAT52MFDEx(Arquivo: AnsiString; Data: AnsiString;cArqDestino:AnsiString): Integer; StdCall; External 'BEMAFI32.DLL';
// Cupom
...
function Daruma_FI_RetornaErroExtendido( ErroExtendido: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
// Informacoes e Status
...
function Daruma_FI_VerificaFormasPagamentoEx( FormasEx: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
...
function Daruma_FI_LerAliquotasComIndice(AliquotasComIndice: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_SaldoAPagar( SaldoAPagar: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_Registry_RetornaValor( Produto: AnsiString; Chave: AnsiString; Valor: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_VerificaHorarioVerao( HoraioVerao: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
...
function Daruma_FI_StatusCupomFiscal( StatusCupomFiscal: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
...
function Daruma_FI_LeituraMemoriaFiscalData( Data_Inicial: AnsiString; Data_Final: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_LeituraMemoriaFiscalReducao( Reducao_Inicial: AnsiString; Reducao_Final: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_LeituraMemoriaFiscalSerialData( Data_Inicial: AnsiString; Data_Final: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_LeituraMemoriaFiscalSerialReducao( Reducao_Inicial: AnsiString; Reducao_Final: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
...
// Cupom
function Daruma_FI_AbreCupom( CPF_ou_CNPJ: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_VendeItemDepartamento( Codigo: AnsiString; Descricao: AnsiString; Aliquota: AnsiString; Valor_Unitario: AnsiString; Quantidade: AnsiString; Valor_do_Desconto: AnsiString; Valor_do_Acrescimo: AnsiString; Indice_Departamento: AnsiString; Unidade_Medida: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_CancelaItemGenerico( Numero_Item: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_CancelaCupom: Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_IniciaFechamentoCupom( Acrescimo_ou_Desconto: AnsiString; Tipo_do_Acrescimo_ou_Desconto: AnsiString; Valor_do_Acrescimo_ou_Desconto: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_EfetuaFormaPagamento( Descricao_da_Forma_Pagamento: AnsiString; Valor_da_Forma_Pagamento: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_TerminaFechamentoCupom( Mensagem_Promocional: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_IdentificaConsumidor( Nome_do_Consumidor: AnsiString; Endereco: AnsiString; CPF_ou_CNPJ: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_FechaCupomResumido( Descricao_da_Forma_de_Pagamento: AnsiString; Mensagem_Promocional: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
// Operações Não Fiscal
function Daruma_FI_AbreComprovanteNaoFiscalVinculado( Forma_de_Pagamento: AnsiString; Valor_Pago: AnsiString; Numero_do_Cupom: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_UsaComprovanteNaoFiscalVinculado( Texto_Livre: AnsiString ): Integer; StdCall; External 'Daruma32.dll'
function Daruma_FI_FechaComprovanteNaoFiscalVinculado: Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_Sangria( Valor_da_Sangria: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_Suprimento( Valor_do_Suprimento: AnsiString; Forma_de_Pagamento: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_RecebimentoNaoFiscal( Indice_do_Totalizador: AnsiString; Valor_do_Recebimento: AnsiString; Forma_de_Pagamento: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_RelatorioGerencial( Texto_Livre: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_FechaRelatorioGerencial: Integer; StdCall; External 'Daruma32.dll';

// Configuração / Programação
function Daruma_FI_ProgramaAliquota( Valor_Aliquota: AnsiString; Tipo_Aliquota: Integer ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_ProgramaHorarioVerao: Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_NomeiaTotalizadorNaoSujeitoIcms( Indice_do_Totalizador: Integer; Nome_do_Totalizador: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_Registry_AlteraRegistry( Chave: AnsiString; ValorChave: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_Registry_ZAutomatica( ZAutomatica: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_CfgRedZAutomatico( Flag: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
function Daruma_FI_ProgramaFormasPagamento( Descricao_das_Formas_Pagamento: AnsiString ): Integer; StdCall; External 'Daruma32.dll';
...
// RSA
function Daruma_RSA_CarregaChavePrivada_Arquivo(Arquivo: AnsiString): Integer; StdCall; External 'Daruma32.dll';
function Daruma_RSA_RetornaChavePublica(N: AnsiString; E: AnsiString): Integer; StdCall; External 'Daruma32.dll';
function Daruma_RSA_CodificaInformacao(Texto: AnsiString; Codigo: AnsiString): Integer; StdCall; External 'Daruma32.dll';
function Daruma_RSA_DecodificaInformacao(Codigo: AnsiString; Texto: AnsiString): Integer; StdCall; External 'Daruma32.dll';
function Daruma_RSA_CodificaInformacao_Hexa(Texto: AnsiString; Codigo: AnsiString): Integer; StdCall; External 'Daruma32.dll';
function Daruma_RSA_DecodificaInformacao_Hexa(Codigo: AnsiString; Texto: AnsiString): Integer; StdCall; External 'Daruma32.dll';
function Daruma_RSA_CriarAssinatura(caminhoDoArquivo: AnsiString ; sMD5: AnsiString; sAssinaturaEletronica: AnsiString): Integer; StdCall; External 'Daruma32.dll';
...
function ECF_DownloadMFD( Arquivo: AnsiString; TipoDownload: AnsiString; ParametroInicial: AnsiString; ParametroFinal: AnsiString; UsuarioECF: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
...
function ECF_DataMovimento(Livre:AnsiString): Integer;StdCall; External 'CONVECF.DLL';
function ECF_RetornoAliquotas(Aliquotas:Pchar ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_VersaoFirmwareMFD(Versao:AnsiString): Integer; StdCall; External 'CONVECF.DLL';
function ECF_VerificaFormasPagamentoEx(FormasPag:AnsiString): Integer; StdCall; External 'CONVECF.DLL';
function ECF_DataHoraGravacaoUsuarioSWBasicoMFAdicional( dataUsuario, dataSWBasico, MFAdicional:AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_GrandeTotal(Texto:AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_MapaResumoMFD:Integer;StdCall; External 'CONVECF.DLL';
function ECF_ContadorCupomFiscalMFD(Valor: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_ContadorRelatoriosGerenciaisMFD(Valor:AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_VerificaRelatorioGerencialMFD(Relats : AnsiString): Integer; StdCall; External 'CONVECF.DLL';
function ECF_NumeroOperacoesNaoFiscais(Valor:AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_ContadorComprovantesCreditoMFD(Valor:AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_MarcaModeloTipoImpressoraMFD(Marca:AnsiString; Modelo:AnsiString; Tipo:AnsiString): Integer; StdCall; External 'CONVECF.DLL';
function ECF_Registry_RetornaValor( Produto: AnsiString; Chave: AnsiString; Valor: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_VerificaHorarioVerao( Tipo: AnsiString): Integer;StdCall; External 'CONVECF.DLL';
function ECF_VerificaTotalizadoresNaoFiscaisEx(Nomes:Pchar ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_StatusCupomFiscal( Tipo: AnsiString): Integer;StdCall; External 'CONVECF.DLL';
function ECF_VerificaAliquotasIss( Flag: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
// Ato copete 17/04
function ECF_ReproduzirMemoriaFiscalMFD(tipo,FxaIni,FxaFim,PatTxt,PatBin:AnsiString): Integer; StdCall; External 'CONVECF.DLL';
function ECF_DownloadMF( nome: AnsiString ): Integer; StdCall; External 'CONVECF.dll';
...
function ECF_LeituraMemoriaFiscalReducaoMFD( cCRZi: AnsiString; cCRZf: AnsiString; tipo:AnsiString ): Integer; StdCall; External 'CONVECF.dll';
function ECF_LeituraMemoriaFiscalDataMFD( cDatai: AnsiString; cDataf: AnsiString; tipo:AnsiString ): Integer; StdCall; External 'CONVECF.dll';
function ECF_LeituraMemoriaFiscalSerialDataMFD( cDatai: AnsiString; cDataf: AnsiString; tipo:AnsiString ): Integer; StdCall; External 'CONVECF.dll';
function ECF_LeituraMemoriaFiscalSerialReducaoMFD( cCRZi: AnsiString; cCRZf: AnsiString; tipo:AnsiString ): Integer; StdCall; External 'CONVECF.dll';
function ECF_LeituraMemoriaFiscalData( DataInicial: AnsiString; DataFinal: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_LeituraMemoriaFiscalReducao( ReducaoInicial: AnsiString; ReducaoFinal: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
// Cupom
function ECF_AbreCupom( CGC_CPF: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_AbreCupomMFD( CGC_CPF, Nome, Endereco: AnsiString ): Integer; StdCall; External 'CONVECF.dll';
function ECF_VendeItemDepartamento( Codigo: AnsiString; Descricao: AnsiString; Aliquota: AnsiString; Quantidade: AnsiString; ValorUnitario: AnsiString; Acrescimo: AnsiString; Desconto: AnsiString; IndiceDepto: AnsiString; UM:AnsiString): Integer; StdCall; External 'CONVECF.dll';
...
// Configuração / Programação
function ECF_ProgramaAliquota( Aliquota: AnsiString; ICMS_ISS: Integer ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_ProgramaHorarioVerao: Integer; StdCall; External 'CONVECF.DLL';
function ECF_NomeiaTotalizadorNaoSujeitoIcms( Indice: Integer; Totalizador: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
...
function ECF_ZAUTO(flag: AnsiString ): Integer; StdCall; External 'CONVECF.DLL';
function ECF_LigaDesligaJanelas(papel:AnsiString;outros:AnsiString): Integer; StdCall; External 'CONVECF.DLL';
...
function EPSON_ECFLigada: AnsiString;
function EPSON_NumeroSerie: AnsiString;
function EPSON_NumeroCaixa: AnsiString;
function EPSON_VersaoSoftwareBasico: AnsiString;
function EPSON_DataHoraSoftwareBasico: AnsiString;
...
// -------------------------------------------------------------------------- //
function Executa_programa(const FileName, Params: AnsiString;
const
...
begin
  ...
  begin
    ...
    if iRetorno = -22 THEN  Result := 'Não foi possível terminar a Impressão!';
    if iRetorno = -23 THEN  Result := 'Não foi possível terminar a Operação!';
  ...
  begin
    ...
    begin
      ...
      Case StrToInt(ST1err) of
        0:  Mensagem := Mensagem + '';
        1:  Mensagem := Mensagem + 'Campo deve ser um ponteiro para AnsiString.';
        2:  Mensagem := Mensagem + 'AnsiString com data inválida.';
        3:  Mensagem := Mensagem + 'AnsiString com hora inválida.';
        4:  Mensagem := Mensagem + 'AnsiString não está vazia ou contém data inválida.';
        5:  Mensagem := Mensagem + 'AnsiString não está vazia ou contém hora inválida.';
        6:  Mensagem := Mensagem + 'AnsiString não pode ser vazia.';
      else
      ...
      Case StrToInt('$' + ST2) of
        ...
        16: Mensagem := Mensagem + 'AnsiString não está vazia ou contém hora inválida.';
      else
...
function cECF_Download(COD_ECF:Integer;tipo:AnsiString;Inicio:AnsiString;Fim:AnsiString):AnsiString;
var
  sArq: AnsiString;
  sArqTroca: AnsiString;
  iTipo: Integer;
...
var
  sRet: AnsiString;
  i, x, Y : integer;
  Formas, sretorno_forma, svalor : AnsiString;
          ...
          begin
            ...
            if i = 1 then // inicio da variavel
              ...
              begin
                ...
                frmModulo.tbForma_Pgto.FieldByName('Nome').asAnsiString := copy(Formas,x,16);
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            FieldByName('Nome').AsAnsiString := copy(Formas, 3,15);
...
var
  sArq: AnsiString;
  sArqTroca: AnsiString;
  cArqDestino, sEntrada, sArquivo: AnsiString;
  i, dias, x: integer;
  Arquivo, sret : AnsiString;
  txt_mfd, txt_Cotepe, txt: textfile;
  dInicial, dFinal :TDate;
  cFlag,  cDownload, cTipo, cTipoDow, cUsuario: AnsiString;
  iACK: Integer;
  iST1: Integer;
  iST2: Integer;
  iST3: Integer;
  ...
  E17, E18, E19, E20, E21, E22, E23, E24, E25 : Array[0..10000] of AnsiString;
  cArqMFD: AnsiString;
  cArqTXT: AnsiString;
  cFormato: AnsiString;
  cTipoDownload: AnsiString;
  cLinha: AnsiString;
...
{         // Cria um objeto do tipo TAnsiStringList.
       ...
       Texto := TAnsiStringList.Create;
       Texto.LoadFromFile( 'EspelhoTMP.TXT' );

       // Copia as informações de data inicial e final, dentro do objeto Texto.

       cDataInicial := copy( Texto.AnsiStrings[ 7 ], 1, 10 );
       cDataFinal   := copy( Texto.AnsiStrings[ Texto.Count - 2 ], 20, 10 );
...
function cECF_Marca_ECF(COD_ECF:integer):AnsiString;
var
  sMarca, sRet, sModelo, sTipo: AnsiString;
  i: integer;
...
var
  ...
  i: integer;
  txt: textfile;
  sVendaBrutaAtual: AnsiString;
  sVendaBrutaAnterior: AnsiString;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          Result := 'Arquivo C:\ACTHAUROS\Retorno.txt não encontrado!';
      end
      else
        Result := sRet;
    end
...
var
  sRet: AnsiString;
  i, x, Y, w: integer;
  sTotalizador, svalor, sTexto: AnsiString;
  sAliquota, sIss: AnsiString;
  rSoma: real;
  iPosNome: Integer;
  iPosValor: Integer;
...
function cECF_Vende_item(COD_ECF:Integer;Codigo,produto,unidade,aliquota:AnsiString;quantidade,valor_unitario,valor_desconto:real;valor_acrescimo:real;tipo_desconto_acrescimo:AnsiString;total:real):AnsiString;
var
  Sqtde, Svalor, Sdesconto, stipo_qtde, sacrescimo : AnsiString;
