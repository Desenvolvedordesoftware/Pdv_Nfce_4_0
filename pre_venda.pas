...
//  frmMsg_Operador.Refresh;
  ...
  qrPre_Venda.SQL.ADD('  c000056.*,');
  qrPre_Venda.SQL.ADD('  c000007.Nome Cliente,');
  qrPre_Venda.SQL.ADD('  c000008.Nome Vendedor');
  qrPre_Venda.SQL.ADD('from');
  qrPre_Venda.SQL.ADD('  c000056, c000007, c000008');
  qrPre_Venda.SQL.ADD('where');
  qrPre_Venda.SQL.ADD('  c000056.codcliente = c000007.codigo and');
  qrPre_Venda.SQL.ADD('  c000056.codvendedor = c000008.codigo and');
  //qrPre_Venda.SQL.ADD('  c000056.tipo <> 9 and');
  qrPre_Venda.sql.add('  c000056.gera_nf = 0');
  qrPre_Venda.sql.add('ORDER BY c000056.CODIGO');
  qrPre_Venda.OPEN;
  ...
  begin
    ...
    begin
      ...
      grid_venda.Cell[2,i].Asstring := qrPre_Venda.fieldbyname('obs1').asstring;
...
begin
  ...
  frmmodulo.query_servidor.sql.add('from c000057 orc,');
  frmmodulo.query_servidor.sql.add('c000025 prod where orc.codproduto = prod.codigo and codorcamento = '''+
 ...
 frmmodulo.query_servidor.Open;
  ...
  begin
    ...
    //iPre_venda_codigo := grid_venda.Cell[0,i].asstring;
